...
def visualize_img(grayscale_img, classnames_list, labels):
    ...
    for j in range(B):
        ...
        plt.savefig('/hpc2hdd/home/jiazhouzhou/jiazhouzhou/code/HumanECLIP/Dataloader/DVS128Gesture/test2.jpg')
        plt.show()

if __name__ == '__main__':
    # test code
    train_path = r"/hpc2hdd/home/jiazhouzhou/jiazhouzhou/code/HumanECLIP/Dataloader/DVS128Gesture/DVS128Gesture_sampled_train.txt"
    tfPath = r"/hpc2hdd/home/jiazhouzhou/jiazhouzhou/code/HumanECLIP/Dataloader/DVS128Gesture/DVS128Gesture.json"
    tf = open(tfPath, "r")
