...
if __name__ == '__main__':
    ...
    train_path = THIS_DIR + r"/DVS128Gesture/DVS128Gesture_train.txt"
    val_path = THIS_DIR + r"/DVS128Gesture/DVS128Gesture_val.txt"

    tf = open(THIS_DIR + "//DVS128Gesture/DVS128Gesture.json", "r")
